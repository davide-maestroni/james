 ...
 */
class BufferedStatementForker<S, V> extends BufferedForker<S, V, Evaluation<V>, Statement<V>>
    implements StatementForker<ForkerStack<S, V, Evaluation<V>, Statement<V>>, V> {

  private static final long serialVersionUID = BuildConfig.VERSION_HASH_CODE;

  private final Forker<S, ? super V, ? super Evaluation<V>, ? super Statement<V>> mForker;

  BufferedStatementForker(
  ...
  private static class ForkerProxy<S, V> extends SerializableProxy {
    ...
    private Object readResolve() throws ObjectStreamException {
      try {
        ...
        return new BufferedStatementForker<S, V>(
