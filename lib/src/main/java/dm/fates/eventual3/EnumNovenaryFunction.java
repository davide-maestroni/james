 ...
 */
public interface EnumNovenaryFunction<P1, P2, P3, P4, P5, P6, P7, P8, P9, V, R> {

  Eventual<R> call(P1 firstParam, P2 secondParam, P3 thirdParam, P4 fourthParam, P5 fifthParam,
      P6 sixthParam, P7 seventhParam, P8 eighthParam, P9 ninthParam, long count, V value) throws
      Exception;
}
