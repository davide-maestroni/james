 ...
 */
class EventuallyStatementExpression<V, R> extends StatementExpression<V, R>
  ...
  EventuallyStatementExpression(@NotNull final Mapper<? super V, ? extends R> mapper) {
  ...
  private static class HandlerProxy<V, R> extends SerializableProxy {
    ...
    private Object readResolve() throws ObjectStreamException {
      try {
        ...
        return new EventuallyStatementExpression<V, R>((Mapper<? super V, ? extends R>) args[0]);
