 ...
 */
class AnyMatchYielder<V> implements LoopYielder<Boolean, V, Boolean>, Serializable {

  private static final long serialVersionUID = BuildConfig.VERSION_HASH_CODE;

  private final Tester<V> mTester;

  AnyMatchYielder(@NotNull final Tester<V> tester) {
  ...
  private static class YielderProxy<V> extends SerializableProxy {
    ...
    private Object readResolve() throws ObjectStreamException {
      try {
        ...
        return new AnyMatchYielder<V>((Tester<V>) args[0]);
