 ...
 */
class FirstOrEmptyJoiner<V> implements LoopJoiner<Integer, V, V>, Serializable {

  private static final FirstOrEmptyJoiner<?> sInstance = new FirstOrEmptyJoiner<Object>();

  private static final long serialVersionUID = BuildConfig.VERSION_HASH_CODE;

  private FirstOrEmptyJoiner() {
  }

  @NotNull
  @SuppressWarnings("unchecked")
  static <V> FirstOrEmptyJoiner<V> instance() {
    return (FirstOrEmptyJoiner<V>) sInstance;
  }
