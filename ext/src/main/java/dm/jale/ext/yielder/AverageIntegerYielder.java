...
import dm.jale.ext.yielder.AverageIntegerYielder.YielderStack;

/**
 * Created by davide-maestroni on 02/19/2018.
 */
class AverageIntegerYielder implements LoopYielder<YielderStack, Number, Integer>, Serializable {

  private static final AverageIntegerYielder sInstance = new AverageIntegerYielder();

  private static final long serialVersionUID = BuildConfig.VERSION_HASH_CODE;

  private AverageIntegerYielder() {
  }

  @NotNull
  static AverageIntegerYielder instance() {
    return sInstance;
  }
