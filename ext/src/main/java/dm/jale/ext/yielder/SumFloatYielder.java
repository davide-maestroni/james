...
import dm.jale.ext.yielder.SumFloatYielder.YielderStack;

/**
 * Created by davide-maestroni on 02/19/2018.
 */
class SumFloatYielder implements LoopYielder<YielderStack, Number, Float>, Serializable {

  private static final SumFloatYielder sInstance = new SumFloatYielder();

  private static final long serialVersionUID = BuildConfig.VERSION_HASH_CODE;

  private SumFloatYielder() {
  }

  @NotNull
  static SumFloatYielder instance() {
    return sInstance;
  }
